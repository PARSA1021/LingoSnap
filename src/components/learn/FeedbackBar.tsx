...
export function FeedbackBar({ result, onNext }: FeedbackBarProps) {
 ...
 className="bg-[var(--color-surface)] border border-[var(--color-border)] shadow-[0_-4px_0_var(--color-border)] rounded-2xl p-4 sm:p-5 overflow-hidden"
 >
 <h4 className="text-[11px] sm:text-xs font-black text-[var(--color-muted-foreground)] uppercase tracking-widest mb-2 ">문법 분석 결과</h4>
