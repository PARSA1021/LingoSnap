...
export default function SpeakingPage() {
 ...
 <Button variant="ghost" size="sm" className="pl-0 text-[var(--color-muted-foreground)] hover:bg-[var(--color-muted)]">
 <ArrowLeft className="w-5 h-5 mr-1" /> 홈으로 가기
 </Button>
 </Link>
 <div className="space-y-2">
 <h1 className="text-3xl sm:text-4xl font-bold text-[var(--color-foreground)]">말하기 연습</h1>
 <p className="text-[var(--color-muted-foreground)]">주어진 문장을 소리 내어 읽고 발음 피드백을 받아보세요.</p>
 </div>
 </div>
