    ...
    <div className="flex-1 p-4 md:p-8 flex flex-col max-w-2xl mx-auto w-full space-y-8 mt-4 md:mt-10 overflow-hidden">
      <div className="flex flex-col gap-6">
        <Link href="/" className="inline-flex w-fit">
          <Button variant="ghost" size="sm" className="pl-0 text-muted-foreground hover:bg-muted">
            <ArrowLeft className="w-5 h-5 mr-1" /> 홈으로 가기
          </Button>
        </Link>
        <div className="space-y-2">
          <h1 className="text-3xl sm:text-4xl font-bold text-foreground">말하기 연습</h1>
          <p className="text-muted-foreground">주어진 문장을 소리 내어 읽고 발음 피드백을 받아보세요.</p>
        </div>
      </div>
